...
#ifndef __ENKI_OBJECT_SENSOR_H
#define __ENKI_OBJECT_SENSOR_H
...
/*!	\file ObjectSensor.h
	\brief Header of the "object type" sensor
*/

namespace Enki
{
	//! A object type sensor.
	/*! \ingroup interaction 
	
	This sensor can determine the distance to an object and the type of that object. It is an enhanced version of the Infrared proximity sensor.

    The proxmity measurement is based on a inverse square response function and three casted rays.
	...
	*/
	class ObjectSensor : public LocalInteraction
	{
	protected:
	...
	public:
		...
		*/
		ObjectSensor(Robot *owner, Vector pos, double height, double orientation, double range, double m, double x0, double c, double noiseSd = 0.);
        ...
        //! Return the type of the detected object
        const std::string& getType(void) const { return object_type; }
	...
	protected:
		...
		bool updateRay(size_t i, double dist);
